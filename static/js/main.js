...
if (sessionStorage.getItem('formText') != null && !$('*').is('.master__blockReviewItem-reviews') && document.querySelector("master__blockFormTextarea")) {
...
function disableEnableInput(input_id){
    inputElement = document.getElementById(input_id)
    if (inputElement.disabled == true) {
        inputElement.disabled = false;
        inputElement.classList = "section__extraFeeInputEnabled"
        inputElement.placeholder = "£";
        }
    else {
        inputElement.disabled = true;
        inputElement.value = '';
        inputElement.classList = "section__extraFeeInputDisabled"
        inputElement.placeholder = "";
        }
}
